...
class GaussianModel:
    ...
    def get_gaussian_properties(self):
        return {
            ...
            #'color': self._features_dc.squeeze(1)
            'color': self._features_dc
        }
        
    def set_gaussian_properties(self, properties):
        self._xyz = properties['xyz']
        self._scaling = properties['scaling']
        self._rotation = properties['rotation']
        self._opacity = properties['opacity']
        self._features_dc = properties['color'].unsqueeze(1)
