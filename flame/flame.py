...
from flame.lbs import lbs, vertices2landmarks, blend_shapes, vertices2joints
...
FLAME_MESH_PATH = "flame/flame/head_template_mesh.obj"
FLAME_LMK_PATH = "flame/flame/landmark_embedding_with_eyes.npy"
...
FLAME_MODEL_PATH = "flame/flame/flame2023.pkl"  # FLAME 2023 (versions w/ jaw rotation)
FLAME_PARTS_PATH = "flame/flame/FLAME_masks.pkl" # FLAME Vertex Masks
...
class FlameHead(nn.Module):
    ...
    def forward3(
        ...
        full_pose = torch.cat(
            [pose_params[:, :3], neck, pose_params[:, 3:], eyes], dim=1
        )
